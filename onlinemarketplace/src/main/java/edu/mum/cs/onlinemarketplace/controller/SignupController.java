...
public class SignupController {
    ...
    public String inputEmployee(@ModelAttribute("user") User employee) {
        return "registerForm";
    }

    @RequestMapping(value = "/register_save")
    public String saveEmployee(@Valid @ModelAttribute("employee") User user, BindingResult bindingResult,
                               Model model) {
